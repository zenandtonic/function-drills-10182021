...
let nameGreeting = (nameCheck("Michael"))
...
function bigOrSmall(arr){
  ...
  let arrayEvaluator = bigOrSmall(answers)
...
// write logic to determine if array is in an ascending order
// if yes, return true
// if no, return false
// create a variable named arrayIsAscending and set equal to function calling an array
// use sample array to test function
